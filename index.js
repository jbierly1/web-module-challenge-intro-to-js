...
let firstThing='thing2';
const secondThing= 10=='10';
...
function hungryDog(weight, age){
  ...
  if(age<1){
    if(age<=.4){return .1 * weight}  
    else if(age<=.7){
      return .05 * weight;
  }else{return .04 * weight}
  }else{
    if(weight<=5){
      return .05*weight
    }else if(weight<=10){
...
for(let i=10;i>0; i--){console.log(annoyingSong(i));
}
